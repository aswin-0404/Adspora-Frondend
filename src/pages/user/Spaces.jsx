...
export default function SpaceListing() {
  ...
  const handleAddToWishlist = async (spaceId) => {
    try {
      ...
      setWishlistMap((prev) => ({ ...prev, [spaceId]: isWishlisted }));
      setWishlistCount((count) => isWishlisted ? count + 1 : Math.max(count - 1, 0));
    } catch (error) {
                ...
                >
                  <div className="relative h-64 w-full overflow-hidden bg-gray-100">
                    ...
                    <button
                      ...
                      className={`absolute top-5 right-5 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-md border ${isWishlisted
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-50">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-indigo-600/20"
                      >
